...
{
    static char *msg[16] = { (char *)"No error", (char *)"Graphics not installed",
        (char *)"Graphics hardware not detected", (char *)"Device driver not found",
        (char *)"Invalid device driver file", (char *)"Insufficient memory to load driver",
        (char *)"Out of memory in scan fill", (char *)"Out of memory in flood fill",
        (char *)"Font file not found", (char *)"Not enough meory to load font",
        (char *)"Invalid mode for selected driver", (char *)"Graphics error",
        (char *)"Graphics I/O error", (char *)"Invalid font file",
        (char *)"Invalid font number", (char *)"Invalid device number" };
